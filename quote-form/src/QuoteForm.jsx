...
const SVCS = {
  shower: [
    { id: "sh1", label: "Fix tiles + corners", trade: "grout lines + corner silicone — the full job", tip: "Remove old grout and silicone, replace fresh. Our bread & butter — 60%+ of shower jobs.", epoxy: true, star: true, befImg: "https://placehold.co/200x140/4a3828/fff?text=Before", aftImg: "https://placehold.co/200x140/e8e4dc/333?text=After", befTxt: "Mouldy grout lines", aftTxt: "Bright white grout" },
    { id: "sh2", label: "Fix just the tile lines", trade: "grout lines only — no corners", tip: "Remove and replace grout only — no silicone corners.", epoxy: true, befImg: "https://placehold.co/200x140/5a4838/fff?text=Before", aftImg: "https://placehold.co/200x140/eae6de/333?text=After", befTxt: "Discoloured grout", aftTxt: "Clean uniform lines" },
    ...
    { id: "sh4", label: "Resurface — change the tile colour", trade: "tile resurfacing", tip: "Spray coating over your existing tiles — any colour you want.", befImg: "https://placehold.co/200x140/7a6a5a/fff?text=Before", aftImg: "https://placehold.co/200x140/f2f0ec/333?text=After", befTxt: "Dated tile colour", aftTxt: "Modern white finish" },
    { id: "sh5", label: "Fix a cracked tile", trade: "tile repair", tip: "Replace or repair broken tiles. You supply the replacement tile.", befImg: "https://placehold.co/200x140/6a5a4a/fff?text=Before", aftImg: "https://placehold.co/200x140/eae8e4/333?text=After", befTxt: "Cracked tile", aftTxt: "Seamless repair" },
  ...
  bath: [
    { id: "bt1", label: "Resurface — make it look new", trade: "bath resurfacing", tip: "Spray coating over your existing bath. Looks brand new.", star: true, befImg: "https://placehold.co/200x140/b8a078/fff?text=Before", aftImg: "https://placehold.co/200x140/f4f2ee/333?text=After", befTxt: "Yellowed enamel", aftTxt: "Glossy white finish" },
    { id: "bt2", label: "Fix a chip or dent", trade: "chip repair", tip: "Fill and colour-match chips. Invisible when done.", befImg: "https://placehold.co/200x140/9a8870/fff?text=Before", aftImg: "https://placehold.co/200x140/f0eeea/333?text=After", befTxt: "Visible chip", aftTxt: "Invisible repair" },
    { id: "bt3", label: "Remove scratches / stains", trade: "polishing / stain removal", tip: "Buff out scratches, remove hard water stains, rust marks, or heat damage.", befImg: "https://placehold.co/200x140/a89880/fff?text=Before", aftImg: "https://placehold.co/200x140/f0eeea/333?text=After", befTxt: "Stains & scratches", aftTxt: "Polished smooth" },
  ...
  basin: [
    { id: "bs1", label: "Resurface — make it look new", trade: "basin resurfacing", tip: "Professional coating over your existing basin.", befImg: "https://placehold.co/200x140/9a8870/fff?text=Before", aftImg: "https://placehold.co/200x140/f2f0ee/333?text=After", befTxt: "Stained porcelain", aftTxt: "Bright white" },
    { id: "bs2", label: "Fix a chip or dent", trade: "chip repair", tip: "Fill and colour-match. Invisible when done.", befImg: "https://placehold.co/200x140/8a7860/fff?text=Before", aftImg: "https://placehold.co/200x140/f0eeea/333?text=After", befTxt: "Chip on rim", aftTxt: "Colour matched" },
  ],
  vanity: [
    { id: "vn1", label: "Resurface the benchtop", trade: "benchtop resurfacing", tip: "New coating on your existing benchtop surface.", befImg: "https://placehold.co/200x140/7a6850/fff?text=Before", aftImg: "https://placehold.co/200x140/eae6e0/333?text=After", befTxt: "Worn laminate", aftTxt: "Smooth new surface" },
    { id: "vn2", label: "Repaint the cabinet", trade: "cabinet respray", tip: "2-pack paint on doors and drawers. Any colour.", cabinet: true, befImg: "https://placehold.co/200x140/6a5840/fff?text=Before", aftImg: "https://placehold.co/200x140/e8e4de/333?text=After", befTxt: "Dated timber", aftTxt: "Modern painted" },
    ...
    { id: "vn4", label: "Fix a chip or scratch", trade: "chip repair", tip: "Fill and colour-match surface damage.", befImg: "https://placehold.co/200x140/7a6a5a/fff?text=Before", aftImg: "https://placehold.co/200x140/eae6e0/333?text=After", befTxt: "Surface damage", aftTxt: "Repaired smooth" },
  ],
  mould: [
  ...
  floor: [
    { id: "fl1", label: "Fix lines between tiles", trade: "floor regrouting", tip: "Replace floor tile grout. Floor tiles outside shower only.", epoxy: true, befImg: "https://placehold.co/200x140/4a3e2e/fff?text=Before", aftImg: "https://placehold.co/200x140/d8d4ce/333?text=After", befTxt: "Dark cracked grout", aftTxt: "Clean uniform grout" },
    ...
    { id: "fl4", label: "Fix a cracked tile", trade: "tile repair", tip: "Replace broken tiles. You supply the replacement tile.", befImg: "https://placehold.co/200x140/5a4e3e/fff?text=Before", aftImg: "https://placehold.co/200x140/d8d4ce/333?text=After", befTxt: "Cracked floor tile", aftTxt: "Seamless match" },
