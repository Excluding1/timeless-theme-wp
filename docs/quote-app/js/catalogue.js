  ...
  TQ.CATALOGUE = [
    {
      ...
      process: 'For the bath we repair any chips, strip and sand back the old surface, prep and mask everything off, then apply a commercial 3-pack coating in gloss white.',
    ...
    },
    {
      ...
      process: 'For the walls we strip the old coatings back, repair and prep the surface, mask everything off, then apply a commercial 3-pack coating in gloss white.',
