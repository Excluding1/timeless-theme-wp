...
- **For MICK specifically:** cost it at the REAL Petr/Sam rates (bath ~$890-980, basin ~$790-840, tile quoted on site), NOT the sheet's optimistic cost → real margin **~25-35% today**, climbing as partner rates are signed. Customer price still off the sheet T2/T3.
