...
| Shower regrouting (epoxy upgrade — specialty) | $70-100/hr | $560-800/day |
| Silicone replacement (less skilled but tedious) | $50-75/hr | $400-600/day |
| Tile resurfacing (similar to bathtub spray) | $80-120/hr | same |
| Bench top resurfacing (skilled spray + finish) | $80-120/hr | same |
| Floor tile regrouting | $60-90/hr | $480-720/day |
| Chip repair / detail work | $90-130/hr (per-job) | smaller jobs |

**Reference points:**
- AU bathroom renovator (full-service trade) = $80-150/hr typical
...
|---|---|---|---|
| Small shower regrout cement (under 1m²) | RSC-01 | **5-7 hrs** | Stuck old grout adds 1-2hr; access difficulty +0.5-1hr |
| Standard shower regrout cement | RSC-02 | **6-9 hrs** | Same plus larger area |
| Standard shower regrout epoxy | RSE-02 | **7-10 hrs** | Epoxy mixing + cure prep adds 1-2hr |
| Standard bath resurface | BTH-01 | **5-7 hrs** | Strip-back if previously coated +2-3hr |
| Large bath resurface | BTH-02 | **6-8 hrs** | Same; freestanding adds access time |
| Full bathroom regrout cement (FBP-01) | | **10-14 hrs over 2 days** | Cure time forces day split |
| Full bathroom regrout epoxy (FBP-02) | | **11-15 hrs over 2 days** | Same |
| Silicone only (shower) | SIL-01 | **1-1.5 hrs** | Cleaning surface back to substrate adds 30 min |
| Floor tile regrouting standard | BFR-02 | **4-6 hrs** | Heavy stains add 1-2hr |

**Bert's tip from transcripts:** experienced sprayer can do a bath in ~2-3 hrs of active work. Total job time longer due to setup, prep (etch, primer cure), cleanup. Scheduling considers cure intervals not just spray time.

### Materials cost reality (cross-checked with Bert/AUSTRS price list)

For a STANDARD shower regrout (cement) — RSC-02:
- Cement grout: $30-45 (Davco, Mapei from Bunnings)
- Silicone (anti-mould): $15-25 (multiple cartridges)
- Grout removal blade: $25-40 per job (consumable)
- Cleaning chemicals: $10-15
- Drop cloths, masking tape, gloves, masks: $15-25
- **Total ~$95-150** (Excel says $117 — REASONABLE)

For STANDARD bath resurface — BTH-01:
- Glas-Tech 9100/9200 resin (1qt portion of $273/gal): ~$68
- Catalyst (1/4 of $69 qt): ~$17
- Ultragrip primer + catalyst (~1qt portion of $262/gal each): ~$130
- Etch (1/4 of $56 32oz): ~$14
- Cleaners + Surface Wash: ~$20
- Drop cloths, masking, masks: ~$15
- Misc consumables (filters, gun cleaner): ~$10
- **Total ~$274** (Excel says $155 — APPEARS LOW per Bert pricing)

⚠️ **Material cost may be undercosted for resurfacing** in Excel. Worth deeper audit.

For EPOXY shower regrout — RSE-02:
- Epoxy grout (Mapei Kerapoxy or similar): $90-130 (premium)
- Silicone, blades, etc: same as cement (~$70)
...
| West | Parramatta, Penrith, Castle Hill | 30-60min | ~$50-80 |
| South | Sutherland, Cronulla | 40-60min | ~$50-70 |
| Outer (Wollongong, Central Coast) | | 60-90min | ~$80-120 |

Travel typically NOT separately invoiced unless beyond zone — built into pricing tier OR commands premium.

### PPE costs (per job)
| Item | Cost per job |
|---|---|
| Respirator + filters | $5-10 (filters $30, last 5-10 jobs) |
| Disposable suit | $5-8 |
| Gloves (multiple pairs) | $3-5 |
| Eye protection | reusable |
| Knee pads | reusable |
| **Total realistic PPE per job** | **$15-25** (Excel says $43-48 for shower jobs — CONSERVATIVE/HIGH) |

### Customer-side market intelligence (Sydney 2026)
| Service | Cheapest competitors | Average market | Premium operators |
|---|---|---|---|
| Standard shower regrout | $700-900 | $1,100-1,400 | $1,600-2,000 |
| Standard bath resurface | $500-700 | $750-1,000 | $1,200-1,500 |
| Full bathroom regrout | $2,000-2,800 | $3,000-3,800 | $4,000-5,200 |
| Silicone reseal only | $200-300 | $350-500 | $500-700 |

Per Bert's intel:
- Bathroom Werx is high-priced + has reputation issues
- Thermoglaze materials are premium-priced
- Many "$300 bathtub resurface" cowboys exist on Hipages — they do bad work, customers come back to us 6 months later
- Customer willingness-to-pay tracks heavily with reviews + photos + warranty terms

### Bert's warranty wisdom (from transcripts)
- Resurfacing = LIFE EXTENDER not new — never sell as new
- Realistic warranty: 5 years private home, 6 months rental
- Up to 7 years pushing it (Bathroom Werx has bad reviews on this)
- 10-year warranty = "not in control of themselves" per Bert
...
## What I look for (when auditing pricing)
...
17. **Customer's willingness-to-pay tracks** with reviews + photos + warranty (which we provide)
18. **No hidden fees** — travel, materials, PPE all baked in transparently

### Strategic signals
19. **Mix-of-services profitability** — full bathroom should be highest-margin per job (premium pricing for combined complexity)
20. **Add-on / upsell opportunities** — basin add-on, double basin, spa flag, epoxy upgrade should all be margin-positive
21. **Loss-leader temptations** — never price below margin to "land" customer, brand suffers
...
Before pricing recommendations:

- [ ] **Web search** for current NSW 2026 trade hourly rates (Hipages, Service.com.au, AusTrades data)
- [ ] **Web search** for current Sydney bathroom resurfacing/regrouting customer prices (top 5 competitors)
...
When delivering pricing recommendations:
...
Plus narrative: "This SKU is priced WELL / TOO HIGH / TOO LOW. Recommended action: [adjust X / keep / remove]."

---

## References

- [data/pricing/master-pricing-2026-05-01-snapshot.xlsx](../../data/pricing/master-pricing-2026-05-01-snapshot.xlsx)
- [data/suppliers/austrs-bert-prices-2026-04-30.csv](../../data/suppliers/austrs-bert-prices-2026-04-30.csv)
- [docs/specs/bert-supplier.md](../specs/bert-supplier.md)
- Bert's transcripts (within docs/specs/bert-supplier.md)
- Sydney trade pricing benchmarks (web search per research mandate)
