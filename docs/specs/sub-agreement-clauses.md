# Spec: Subcontractor Agreement — 32 Clauses (Sprintlaw Brief)
...
**Re-verification cadence:** Annually + after any major regulatory change (Fair Work amendments, UCT updates, ATO changes).
...
| Lens | Verdict | Notes |
|---|---|---|
| Domain ([expert-trades-ops-contractor](../roles/expert-trades-ops-contractor.md)) | 🟢 Approve | 32 clauses comprehensive. Sham-contracting protections correct. Termination tiers well-categorised. Publishable as Sprintlaw brief. |
| Adversarial — Fair Work ([auditor-fair-work](../roles/auditor-fair-work.md)) | 🟢 Approve | Multiple sham-contracting protections: Clause 1 (status), Clause 2 (decline/delegation rights), Clause 12 (mutual termination + payment), Clause 25 (mutual indemnity = UCT-compliant) |
| Adversarial — Compliance AU ([auditor-compliance-aus](../roles/auditor-compliance-aus.md)) | 🟢 Approve with verification | Citations to verify 2026-current: s175B WCA 1987 (still current per amendments), SOPA 1999 NSW, WHS Act 2011, Privacy Act 1988, UCT amendments Nov 2023 ($50M penalties), TPAR. **Sprintlaw must do final compliance review.** |

**Decision:** ✅ Migrate as Sprintlaw brief. Engage Sprintlaw with this doc + ~$200 budget. Sprintlaw's mandate: convert to legal language + UCT review per Clause 22 instruction.

---

## Engagement instructions for Sprintlaw

1. Use this brief to draft a formal NSW Subcontractor Agreement
2. Convert plain English to enforceable legal language
...
### Clause 12 — Termination and Breach Severity Tiers
**Wording:** Either party may terminate:
(a) With **14 days written notice** without cause
(b) **Immediately** for material breach as defined below

All outstanding payments for completed work paid within 7 business days of termination (SOPA compliance).

**IMMEDIATE TERMINATION (no warning):**
- Insurance lapsed + worked uninsured (Clause 8)
- WHS violation creating imminent danger (Clause 14)
- Disturbing suspected asbestos (Clause 19)
- Attending site under influence (Clause 26c)
- Entering restricted areas of customer's home (Clause 26e)
- Fraud, theft, dishonesty

**WARNING FIRST, THEN TERMINATE IF REPEATED:**
- Unapproved materials (Clause 4)
- Defective work + refusing to rectify (Clauses 5+6)
- Repeated failure to submit photos (Clause 7)
- Soliciting introduced customers (Clause 9)
- Pricing discussion or confidentiality breach (Clause 10)
- Posting customer photos on own social media (Clause 20)
- Unapproved extra work on site (Clause 21)
- Misusing customer data (Clause 23)
- Repeated lateness, poor cleanup, smoking, direct selling, unapproved helpers (Clauses 26, 27)
- Failure to return on multi-day job without notice (Clause 31)
- Cancelling committed job with <48hrs notice (Clause 32) — 3+ in 90 days = immediate termination
- Failure to respond to warranty callback within 48hrs (Clause 29)

**NOT GROUNDS FOR TERMINATION** (procedural/payment clauses): Clauses 1, 2, 3, 11, 13, 15, 16, 17, 22, 24, 25, 28, 30

**Why:** Without defined severity tiers, "material breach" is ambiguous. Mutual termination + payment on termination required for UCT compliance.

### Clause 13 — Dispute Resolution
**Wording:** Disputes resolved via:
(a) Direct negotiation (14 days)
(b) Mediation via NSW Small Business Commissioner (free service)
(c) If unresolved, legal remedies
...
### Clause 16 — Security of Payment Act
**Wording:** Building and Construction Industry Security of Payment Act 1999 (NSW) applies. Payment claim cycles + adjudication rights per the Act.
...
(d) Building-specific requirements (lift booking, parking, common-area protection)
...
(d) Leave site if necessary

**Disturbance of suspected asbestos = immediate termination.**
...
> *"Review the entire agreement for unfair contract terms under Australian Consumer Law (Schedule 2, Competition and Consumer Act 2010). Since November 2023, unfair terms in standard form small business contracts are ILLEGAL (not just voidable). Penalties up to $50M per contravention. Pay particular attention to: Clauses 6 (deductions), 9 (non-solicitation), 12 (termination), 15 (rate changes), and 25 (indemnity)."*
...
(a) Extreme heat (>39°C — spray painting unsafe)
(b) Bushfire smoke (respiratory hazard for coatings)
(c) Floods, storms, severe weather
(d) Government restrictions / lockdowns

Affected party notifies other within 24 hours.

**Why:** Sydney gets extreme heat days. Spray painting >39°C = product failure + safety risk. Protects both parties from penalty.
...
(d) **SMOKING**: No smoking on customer's property
(e) **RESTRICTED AREAS**: Stay in work area. Don't enter other rooms, use customer's belongings, or access wifi
(f) **CLEANUP**: Leave area cleaner than found. Remove all waste, packaging, sheeting
(g) **PRICING**: "All pricing goes through the office"
(h) **NO DIRECT SELLING**: No upsells, no business cards
...
- 48+ hrs notice: OK
- <48 hrs: WARNING
- <24 hrs: $100 fee (deducted from next payment)
- 3+ late cancellations in 90 days: termination
...
### Schedule B — Approved Materials List
Per [docs/sop/sub-materials-standard.md](../sop/sub-materials-standard.md).
- Resurfacing: Hawk via ARS only
- Regrouting cement: Davco / Ardex / Laticrete approved
- Regrouting epoxy: Ardex EG15 / Davco K10 / Laticrete SpectraLOCK approved
- PPE, disposables, tools per SOP

### Schedule C — Coverage Zones + Travel Allowances
Per OPERATING-CONTEXT.md geographic zones.
- Inner (CBD/Bondi/Inner West): zone fee $X
- North (Mosman/Chatswood/Hornsby): $Y
- West (Parramatta/Penrith/Castle Hill): $Z
- Etc — TBC after pricing audit
...
- Termination tiers (immediate vs warning-then-terminate)
- Photo + scope-change processes
- Conduct standards
...
- [docs/sop/sub-vetting-checklist.md](../sop/sub-vetting-checklist.md) — pre-signing
- [docs/sop/sub-trial-job-protocol.md](../sop/sub-trial-job-protocol.md) — pre-signing
- [docs/sop/sub-quality-rubric.md](../sop/sub-quality-rubric.md) — quality standards (Clause 5)
- [docs/sop/sub-materials-standard.md](../sop/sub-materials-standard.md) — approved materials (Clause 4)
- [docs/specs/pricing-audit-2026-05.md](pricing-audit-2026-05.md) — finalises Schedule A rates
- Sprintlaw quote: ~$200 for template + customisation
- Australian Consumer Law (Schedule 2 of Competition and Consumer Act 2010)
- Workers Compensation Act 1987 (NSW) s175B
- Building and Construction Industry Security of Payment Act 1999 (NSW)
- Privacy Act 1988 (Cth)
- Fair Work Act 2009 (Cth) — 2024 amendments on whole-of-relationship test
- Work Health and Safety Act 2011 (NSW) + Regulation 2017
