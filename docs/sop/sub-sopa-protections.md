# SOP: NSW Security of Payment Act (SOPA) Protections

**Source:** Migrated from `data/archive/old-drafts-2026-04/extracted-sub-onboarding/12-security-of-payment.md` (sub-onboarding-system.xlsx Sheet 12).
**Audited via:** [auditor-compliance-aus.md](../roles/auditor-compliance-aus.md) + [auditor-fair-work.md](../roles/auditor-fair-work.md)
**Companion to:** [sub-agreement-clauses.md § Clause 16](../specs/sub-agreement-clauses.md), [sub-rate-schedule.md § D Payment process](../specs/sub-rate-schedule.md), [sub-tax-compliance.md](sub-tax-compliance.md)

---

## ⚠️ Read first

This is operational guidance, not legal advice. Engage Sprintlaw or a NSW construction lawyer for any disputed SOPA claim ≥$5K. The 10-business-day response deadline is unforgiving.

---

## What SOPA is + why it applies to us

**The Building and Construction Industry Security of Payment Act 1999 (NSW)** gives subcontractors statutory rights to be paid for completed work. It overrides contract terms — any contract clause trying to exclude SOPA rights is **VOID**.

### Does SOPA apply to our business?
...
**Our contract specifies 7-14 business days** (per [Clause 16](../specs/sub-agreement-clauses.md) + [sub-rate-schedule.md § D](../specs/sub-rate-schedule.md)) — that's compliant (shorter than statutory max). We just have to actually pay within that period.

### 2. Right to serve a payment claim

A valid SOPA payment claim must:
- Identify the construction work done
- State the amount claimed
- **State that it's made under the Act** (this phrase makes it a SOPA claim, not just an invoice)

**Once we receive a valid SOPA payment claim, we have 10 BUSINESS DAYS to respond with a "payment schedule"** (stating what we'll pay and why, if less than claimed).
...
## ⚠️ Hard rules for us — what NEVER to do

### NEVER ignore a SOPA payment claim
...
**Always respond within 10 business days.** Even if just to say "we dispute, payment schedule for $X with reasons."
...
Any contract clause trying to exclude SOPA is void by statute (s34). Don't waste lawyer time drafting carve-outs — they're unenforceable.

---

## Our SOPA-compliant process
...
> We propose to pay $[reduced amount] for the following reasons:
> 1. [Specific quality issue with photo evidence]
> 2. Per Clause 6 of the Subcontractor Agreement, we are deducting $[X] for [specific rectification cost].
> Balance due: $[reduced amount], payable per contract terms.
> If you disagree, you may apply for adjudication under the Act."

### Day 5-7: Approve invoice for payment

Once quality verified + NSW Subcontractor's Statement received → approve in Xero. Weekly batch approve all invoices received that week.

### Day 7-14: Process payment
...
- Xero payment record
- Job photos
- Any quality notes / payment schedule (if issued)

Retention: 5 years ATO minimum, 7 years recommended for SOPA disputes.

---

## Supporting Statement obligation (head contractor)
...
## When SOPA helps US (it's not just sub-side)

If a customer doesn't pay us:
- We can serve our own payment claim under SOPA
- Customer has 10 business days to respond
- If they don't → we adjudicate → enforceable like court judgment

**This is faster + cheaper than small claims court** for residential customers >$1K. Adjudication: 10-15 business days from claim. Small claims court: 6-12 months typical.

For our $1,500-3,500 typical bathroom jobs, SOPA adjudication is the right tool when customer non-payment crosses 30 days.
...
## What we put in the contract (Clause 16)

```
The parties acknowledge that the Building and Construction Industry Security of
Payment Act 1999 (NSW) applies to this Agreement. Payment claims must be
submitted monthly (or per job completion). The Principal will respond to any
payment claim within 10 business days. Payment is due within 14 business days
of a valid payment claim.
```

This clause:
- Acknowledges SOPA (good faith signal)
- Sets payment claim cycle (per job or monthly)
- Confirms our response timeframe (10 days)
- Sets payment terms within statutory maximum (14 < 20 max)

Cross-reference: [sub-agreement-clauses.md § Clause 16](../specs/sub-agreement-clauses.md).
...
- [sub-agreement-clauses.md § Clause 16](../specs/sub-agreement-clauses.md) — SOPA acknowledgement clause
- [sub-rate-schedule.md § D Payment process](../specs/sub-rate-schedule.md) — operational payment workflow
- [sub-ongoing-quality-monitoring.md § 9 Offboarding](sub-ongoing-quality-monitoring.md) — final-payment-within-7-days SOPA discipline
- [sub-risk-scenarios-playbook.md § Scenario 10](sub-risk-scenarios-playbook.md) — customer non-payment scenario (we use SOPA for this)
- [auditor-compliance-aus.md](../roles/auditor-compliance-aus.md) — compliance auditor lens
- NSW Fair Trading SOPA page: [fairtrading.nsw.gov.au](https://www.fairtrading.nsw.gov.au) (search "Security of Payment")
- Authorised Nominating Authorities (NSW): list at fairtrading.nsw.gov.au
- Building and Construction Industry Security of Payment Act 1999 (NSW): [legislation.nsw.gov.au](https://legislation.nsw.gov.au)
