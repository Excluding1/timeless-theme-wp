...
### 1. Gumtree + Facebook Marketplace

**How:** Post ad — *"Experienced bathroom regrout/resurfacing technician wanted — subcontractor basis"* (full ad copy in [docs/templates/recruitment-ads.md](../templates/recruitment-ads.md))
...
### 2. Facebook Groups (trade-specific)
...
### 3. Seek / Indeed (contractor listings)

**How:** Post as **contractor opportunity, not employment**.

**Wording matters for sham contracting protection** (per [auditor-fair-work.md](../roles/auditor-fair-work.md)):
...
**How:** Search "regrout" / "resurfacing" providers. Look at:
- Reviews (5+ jobs with 4-5 stars = signal)
- Response time
...
**Failure mode:** good operators on Hipages already have full books. We need to offer something they want — typically that's "all admin handled by us" + "consistent volume" + "fair flat rates".

### 5. ARS (Australasian Resurfacing Supplies — Bert Heynen)
...
**How:** Approach people who've worked for franchise models — they understand dispatch operations, quality standards, photo documentation.
...
**⚠️ Failure mode:** **conflict with our "don't train tradies" CEO policy.** Per [Override 12](../CEO.md), we don't train. Use this channel only when:
1. Established channels saturated
2. We have specific quality gap (e.g., need a colour-matching specialist) we can't find pre-trained
3. We've planned the training cost into the rate model

---

## How we run recruitment as a continuous process

**Frequency:** ongoing, not phase-locked. Per [CEO recurring cadences](../CEO.md#recurring-operational-cadences-added-2026-05-01-pm) — bi-weekly Marko/Allan add 10 new prospects to outreach list.

**Channel mix per quarter:**
- Channel 6 (existing network referrals): 30%+ — best ROI
- Channels 1, 2, 4 (Gumtree, FB groups, Hipages): 50% combined — volume
- Channels 5, 7 (ARS Bert, franchise alumni): 15% — quality
- Channel 3 (Seek/Indeed): 5% — opportunistic
...
## Compliance language audit (run before every ad post)
...
If any ad uses ❌ terms, that ad is sham-contracting evidence forever. Take it down + repost compliant version.
...
- [docs/templates/recruitment-ads.md](../templates/recruitment-ads.md) — ad copy templates for each channel
- [sub-vetting-checklist.md](sub-vetting-checklist.md) — what to check on each candidate
- [sub-trial-job-protocol.md](sub-trial-job-protocol.md) — paid trial after vetting passes
- [sub-onboarding-checklist.md](sub-onboarding-checklist.md) — post-trial onboarding
- [sub-sham-contracting-protections.md](sub-sham-contracting-protections.md) — language compliance
- [docs/specs/bert-supplier.md](../specs/bert-supplier.md) — Bert / ARS channel context
- [docs/CEO.md § Override 12](../CEO.md) — "recruit pre-trained, don't train"
