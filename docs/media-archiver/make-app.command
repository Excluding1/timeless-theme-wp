#!/bin/zsh
# Build "Media Archiver.app" — a clickable Mac app that launches the local
...
if [[ ! -x "\$PY" ]]; then
  /usr/bin/osascript -e 'display alert "Media Archiver" message "First-time setup needed — open Terminal in the project folder and run the setup in README.md." as critical'
  exit 1
fi
...
echo "\n✅ Installed: $APP"
echo "Find it in Launchpad / Spotlight (\"Media Archiver\"), or drag it to your Dock."
open -R "$APP"
