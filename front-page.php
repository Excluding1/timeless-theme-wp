...
<section class="relative pt-28 sm:pt-32 pb-16 sm:pb-20 bg-surface">
 ...
 <img id="mob-before-img" src="<?php echo get_template_directory_uri(); ?>/images/homepage/before.jpg" alt="Before bathroom resurfacing" draggable="false" class="absolute inset-0 w-full h-full object-cover" style="object-position:center 70%;" width="800" height="600" />
 </div>
 ...
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/before.jpg" alt="Before bathroom resurfacing Sydney" draggable="false" id="ba-before-img" class="absolute inset-0 w-full h-full object-cover" width="800" height="960" />
 </div>
...
<section class="bg-primary text-white py-4">
 ...
 #chipbar-inner{display:flex;width:max-content;gap:28px;align-items:center;}
 #chipbar-inner>div{white-space:nowrap;}
 }
 @media (min-width:640px){
 #chipbar-inner{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:16px;}
 #chipbar-inner>div.chip-dup{display:none;}
 }
 </style>
...
<section class="py-16 sm:py-24 bg-surface-container-low" id="services">
 ...
 <div class="w-24 h-24 rounded-full bg-emerald-50 mx-auto mb-4 relative overflow-hidden">
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/bath-resurfacing.png" srcset="<?php echo get_template_directory_uri(); ?>/images/homepage/bath-resurfacing-400w.png 400w, <?php echo get_template_directory_uri(); ?>/images/homepage/bath-resurfacing.png 800w" sizes="(max-width: 640px) 200px, 250px" alt="Bath resurfacing service" class="absolute inset-0 w-full h-full object-cover rounded-full" width="400" height="400" loading="lazy" />
 </div>
 ...
 <div class="w-24 h-24 rounded-full bg-emerald-50 mx-auto mb-4 relative overflow-hidden">
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/tile-resurfacing.png" srcset="<?php echo get_template_directory_uri(); ?>/images/homepage/tile-resurfacing-400w.png 400w, <?php echo get_template_directory_uri(); ?>/images/homepage/tile-resurfacing.png 800w" sizes="(max-width: 640px) 200px, 250px" alt="Tile resurfacing service" class="absolute inset-0 w-full h-full object-cover rounded-full" width="400" height="400" loading="lazy" />
 </div>
 ...
 <div class="w-24 h-24 rounded-full bg-emerald-50 mx-auto mb-4 relative overflow-hidden">
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/vanity-resurfacing.png" srcset="<?php echo get_template_directory_uri(); ?>/images/homepage/vanity-resurfacing-400w.png 400w, <?php echo get_template_directory_uri(); ?>/images/homepage/vanity-resurfacing.png 800w" sizes="(max-width: 640px) 200px, 250px" alt="Vanity resurfacing service" class="absolute inset-0 w-full h-full object-cover rounded-full" width="400" height="400" loading="lazy" />
 </div>
 ...
 <div class="w-24 h-24 rounded-full bg-emerald-50 mx-auto mb-4 relative overflow-hidden">
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/basin-resurfacing.png" srcset="<?php echo get_template_directory_uri(); ?>/images/homepage/basin-resurfacing-400w.png 400w, <?php echo get_template_directory_uri(); ?>/images/homepage/basin-resurfacing.png 800w" sizes="(max-width: 640px) 200px, 250px" alt="Basin resurfacing service" class="absolute inset-0 w-full h-full object-cover rounded-full" width="400" height="400" loading="lazy" />
 </div>
...
<section class="py-16 sm:py-24 bg-primary" id="warranty">
 ...
 <div class="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/15 transition-all duration-300"><div class="shrink-0 w-10 h-10 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="material-symbols-outlined text-lg text-[#e7c08b]" aria-hidden="true">verified_user</span></div><div><h3 class="font-bold text-white text-sm mb-0.5">Adhesion Cover</h3><p class="text-xs text-white/60">Multi-step prep ensures permanent bonding. Failure covered in full.</p></div></div>
