...
<section class="relative pt-28 sm:pt-32 pb-16 sm:pb-20 bg-surface">
 ...
 <img id="mob-before-img" src="<?php echo get_template_directory_uri(); ?>/images/homepage/before.jpg" alt="Before bathroom resurfacing" draggable="false" class="absolute inset-0 w-full h-full object-cover" style="object-position:center 70%;" fetchpriority="high" width="800" height="600" />
 </div>
 ...
 <img src="<?php echo get_template_directory_uri(); ?>/images/homepage/before.jpg" alt="Before bathroom resurfacing Sydney" draggable="false" id="ba-before-img" class="absolute inset-0 w-full h-full object-cover" fetchpriority="high" width="800" height="960" />
 </div>
