    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-12">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/brand/tr-mark.png" alt="Timeless Resurfacing TR logo" class="block mb-2" width="128" height="128" style="height:128px;width:auto;filter:drop-shadow(1.5px 0 0 #fff) drop-shadow(-1.5px 0 0 #fff) drop-shadow(0 1.5px 0 #fff) drop-shadow(0 -1.5px 0 #fff);" loading="lazy" />
                <?php endif; ?>
