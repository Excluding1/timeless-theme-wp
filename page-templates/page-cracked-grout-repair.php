...
<script type="application/ld+json">
 ...
 { "@type": "Question", "name": "How much does shower regrouting cost?", "acceptedAnswer": { "@type": "Answer", "text": "Every shower is different, so we provide fixed-price quotes based on photos of your specific situation. Send us 3-4 photos and we'll have a quote back to you within 1 business day. No call-out fee, no obligation." } },
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <p class="text-secondary max-w-3xl mb-10">Grout doesn't just crack for no reason. Understanding the cause helps you see why a full regrout. Not a patch job. Is the right fix.</p>
 ...
 <p class="text-sm text-secondary leading-relaxed">All buildings settle and shift slightly over time. Cement grout is rigid. It can't flex with the movement, so it cracks at the joints. This is especially common in older Sydney homes.</p>
 </div>
 <div class="bg-surface-container-low rounded-xl p-6 reveal">
 ...
 <p class="text-sm text-secondary leading-relaxed">Once a small crack forms, water gets in behind the grout and weakens it from the back. This accelerates the breakdown. Cracks get wider, grout starts falling out in chunks.</p>
 </div>
 <div class="bg-surface-container-low rounded-xl p-6 reveal">
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-error text-base shrink-0" aria-hidden="true">close</span> Grout pens only coat the surface. Cracks remain underneath</li>
 ...
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-primary text-base shrink-0" aria-hidden="true">check</span> Fresh grout bonds directly to clean tile. Proper adhesion</li>
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-primary text-base shrink-0" aria-hidden="true">check</span> Uniform finish across every joint. Looks brand new</li>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 ...
 <p class="text-xs text-secondary leading-relaxed">Using oscillating multi-tools with diamond-tipped blades, we remove ALL the old damaged grout. Not just the cracked sections. Every joint is cut back to expose clean tile edges for proper adhesion.</p>
 </div>
 <div class="bg-white rounded-xl p-6 reveal">
 ...
 <p class="text-xs text-secondary leading-relaxed">Cement grout is sealed with a penetrating sealer to create a moisture barrier and extend its lifespan. Epoxy grout is waterproof from day one and doesn't need sealing. Ever.</p>
 </div>
 <div class="bg-white rounded-xl p-6 reveal">
...
<section class="py-16 sm:py-20 bg-surface-container-low" id="quote">
 ...
 <p class="text-on-primary-container text-sm sm:text-base mb-8 max-w-xl mx-auto">Send us 3-4 photos of your shower grout and we'll have a fixed-price quote back to you within 1 business day. No obligation, no call-out fee.</p>
