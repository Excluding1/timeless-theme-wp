<?php
/* Template Name: Sydney City Home */
/**
 * Sydney city homepage. Currently a duplicate of the main homepage
 * (front-page.php) for staged nationwide expansion:
 *
 *   Phase 1 (now): / and /sydney/ have identical Sydney-focused content
 *   Phase 2 (when Melbourne launches): / becomes Australia-neutral,
 *                                       /sydney/ stays as the Sydney-specific
 *                                       version (this file diverges from front-page.php)
 *
 * Until divergence, this file = front-page.php verbatim.
 */
get_header(); ?>
