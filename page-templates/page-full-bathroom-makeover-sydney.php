    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 reveal">
                ...
                <p class="text-xs text-secondary leading-relaxed">You walk into a bathroom that looks brand new. Fresh bath, clean tiles, crisp grout, renewed vanity and basin. Same layout, completely different feel. Backed by our 3-year workmanship warranty.</p>
            </div>
        </div>
    </div>
</section>
