...
<script type="application/ld+json">
    {
        ...
        "mainEntity": [
            ...
            { "@type": "Question", "name": "Do you work on weekends?", "acceptedAnswer": { "@type": "Answer", "text": "We primarily work Monday to Friday, but we can arrange Saturday work for urgent jobs or when weekday access isn't possible. Let us know your situation when you enquire and we'll do our best to accommodate." } },
...
<div class="pt-24 pb-2 px-6 sm:px-8 max-w-7xl mx-auto">
    <nav class="text-xs text-secondary" aria-label="Breadcrumb">
        <ol class="flex items-center gap-1">
            ...
            <li><span class="mx-1">/</span></li>
            <li class="text-primary font-medium">Full Bathroom Makeover</li>
        </ol>
    </nav>
</div>
...
<section class="pt-4 pb-16 sm:pb-20 bg-surface">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
            <span class="inline-block py-1 px-3 bg-primary text-white text-[0.7rem] font-bold tracking-widest uppercase rounded mb-4">Full Package</span>
            ...
            <div class="flex items-center gap-6 mb-8">
                <div class="text-center">
                    <p class="text-3xl font-extrabold text-primary">2-3 Days</p>
                    <p class="text-xs text-secondary">Complete makeover</p>
                </div>
                <div class="h-10 w-px bg-surface-container"></div>
                <div class="text-center">
                    <p class="text-3xl font-extrabold text-primary">Save 70%+</p>
                    <p class="text-xs text-secondary">vs renovation</p>
                </div>
                <div class="h-10 w-px bg-surface-container"></div>
                <div class="text-center">
        ...
        <div class="aspect-[4/3] bg-surface-container-highest rounded-xl overflow-hidden shadow-xl">
            <img class="w-full h-full object-cover" alt="Complete bathroom makeover in Sydney — bath, tiles, grout, vanity and basin all resurfaced to look brand new without renovation" src="https://images.unsplash.com/photo-1584622650806-aa5c5c78b7f3?w=800&h=600&fit=crop&auto=format&q=80" loading="eager" width="800" height="600" />
        </div>
    </div>
</section>
...
<section class="bg-primary text-white py-4">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 flex flex-wrap justify-center sm:justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-2"><span class="material-symbols-outlined text-tertiary-fixed-dim" aria-hidden="true">schedule</span><span class="text-xs font-bold">Done in Days</span></div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="<?php echo esc_url( home_url( '/services/bath-resurfacing-sydney/' ) ); ?>" class="group bg-surface-container-low rounded-xl p-6 hover:shadow-lg transition-all reveal">
                <span class="material-symbols-outlined text-3xl text-primary mb-3 block" aria-hidden="true">bathtub</span>
                <h3 class="font-bold text-primary mb-2 group-hover:underline">Bath Resurfacing</h3>
                <p class="text-sm text-secondary leading-relaxed">Your bath is resurfaced with a durable new coating in your choice of colour and finish. Covers chips, stains, discolouration and worn enamel. Looks and feels like a brand new bath.</p>
            </a>
            <a href="<?php echo esc_url( home_url( '/services/tile-resurfacing-sydney/' ) ); ?>" class="group bg-surface-container-low rounded-xl p-6 hover:shadow-lg transition-all reveal">
                <span class="material-symbols-outlined text-3xl text-primary mb-3 block" aria-hidden="true">dashboard</span>
                <h3 class="font-bold text-primary mb-2 group-hover:underline">Tile Resurfacing</h3>
                <p class="text-sm text-secondary leading-relaxed">Wall tiles and/or floor tiles recoated in a fresh colour. Dated patterns, ugly colours, and surface damage all disappear under a smooth, modern finish. No tile removal needed.</p>
            </a>
            <a href="<?php echo esc_url( home_url( '/services/shower-regrouting-sydney/' ) ); ?>" class="group bg-surface-container-low rounded-xl p-6 hover:shadow-lg transition-all reveal">
                <span class="material-symbols-outlined text-3xl text-primary mb-3 block" aria-hidden="true">grid_view</span>
                <h3 class="font-bold text-primary mb-2 group-hover:underline">Full Regrouting</h3>
                <p class="text-sm text-secondary leading-relaxed">All old grout removed and replaced with fresh, clean material. Cracked, stained, and mouldy grout lines are completely renewed. Your grout lines look crisp and uniform again.</p>
            </a>
            <div class="bg-surface-container-low rounded-xl p-6 reveal">
                ...
                <h3 class="font-bold text-primary mb-2">Silicone Replacement</h3>
                <p class="text-sm text-secondary leading-relaxed">All old silicone stripped from floor-wall junctions, internal corners, and around fixtures. Replaced with premium wet-area silicone rated for long-term mould resistance. Completes the watertight seal.</p>
            </div>
            <a href="<?php echo esc_url( home_url( '/services/vanity-refinishing-sydney/' ) ); ?>" class="group bg-surface-container-low rounded-xl p-6 hover:shadow-lg transition-all reveal">
                <span class="material-symbols-outlined text-3xl text-primary mb-3 block" aria-hidden="true">countertops</span>
                <h3 class="font-bold text-primary mb-2 group-hover:underline">Vanity Respray</h3>
                <p class="text-sm text-secondary leading-relaxed">Your vanity cabinet resprayed in a new colour to match the refreshed bathroom. Covers wear, water damage, peeling laminate, and outdated wood tones. Solid, factory-quality finish.</p>
            </a>
            <a href="<?php echo esc_url( home_url( '/services/basin-restoration-sydney/' ) ); ?>" class="group bg-surface-container-low rounded-xl p-6 hover:shadow-lg transition-all reveal">
                <span class="material-symbols-outlined text-3xl text-primary mb-3 block" aria-hidden="true">wash</span>
                <h3 class="font-bold text-primary mb-2 group-hover:underline">Basin Restoration</h3>
                <p class="text-sm text-secondary leading-relaxed">Your basin resurfaced to remove stains, chips, and discolouration. Finished to match your new vanity and overall bathroom colour scheme. Smooth, glossy, like-new result.</p>
            </a>
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4">How It Works</h2>
        <p class="text-secondary max-w-3xl mb-10">From first enquiry to finished bathroom in four simple steps.</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 reveal">
                ...
                <p class="text-xs text-secondary leading-relaxed">We assess your photos and quote you a single fixed price for everything your bathroom needs. No hidden extras, no hourly rates. You know exactly what you're paying before we start.</p>
            </div>
            <div class="bg-white rounded-xl p-6 reveal">
            ...
            <div class="bg-white rounded-xl p-6 reveal">
                ...
                <p class="text-xs text-secondary leading-relaxed">You walk into a bathroom that looks brand new. Fresh bath, clean tiles, crisp grout, renewed vanity and basin. Same layout, completely different feel. Backed by our 2-year warranty.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            <div class="bg-surface-container-low rounded-xl p-8 border-2 border-surface-container">
                <h3 class="font-bold text-primary mb-4 flex items-center gap-2"><span class="material-symbols-outlined text-error" aria-hidden="true">close</span> Full Renovation</h3>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 reveal">
                ...
                <p class="text-sm text-secondary leading-relaxed">Preparing a property for sale? A bathroom makeover is one of the highest-ROI improvements you can make. Instant visual impact for buyers at a fraction of renovation cost.</p>
            </div>
            <div class="bg-white rounded-xl p-6 reveal">
...
<section class="py-16 sm:py-20 bg-white" id="faqs">
    <div class="max-w-3xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4 text-center">Bathroom Makeover FAQs</h2>
        ...
        <div class="space-y-3">
            ...
            <div class="faq-item border border-surface-container rounded-xl bg-surface-container-low"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Do you work on weekends?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">We primarily work Monday to Friday. However, we can arrange Saturday work for urgent jobs or when weekday access isn't possible &mdash; for example, landlords needing a quick turnaround between tenants. Let us know your situation when you enquire and we'll do our best to accommodate.</p></div></div>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4">Individual Services</h2>
        <p class="text-secondary max-w-3xl mb-10">Need just one or two things done instead of the full package? Each of these is available as a standalone service.</p>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="<?php echo esc_url( home_url( '/services/shower-regrouting-sydney/' ) ); ?>" class="group bg-white rounded-xl p-6 hover:shadow-lg transition-all">
                ...
                <p class="text-xs text-secondary">Remove old grout and replace with fresh material</p>
            </a>
            <a href="<?php echo esc_url( home_url( '/services/vanity-refinishing-sydney/' ) ); ?>" class="group bg-white rounded-xl p-6 hover:shadow-lg transition-all">
                ...
                <p class="text-xs text-secondary">Respray your vanity in a fresh new colour</p>
            </a>
        </div>
    </div>
</section>
