            ...
            <div class="bg-surface-container-low rounded-xl p-6 reveal border border-surface-container hover:shadow-lg transition-all">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-secondary leading-relaxed">New coating, your choice of colour and finish</p>
                    </div>
                </div>
            </div>
            <!-- Tile 2 -->
            <div class="bg-surface-container-low rounded-xl p-6 reveal border border-surface-container hover:shadow-lg transition-all">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-secondary leading-relaxed">Wall and/or floor tiles recoated in a fresh colour</p>
                    </div>
                </div>
            </div>
            <!-- Tile 3 -->
