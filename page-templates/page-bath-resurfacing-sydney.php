    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
            ...
            <div class="flex items-center gap-6 mb-8">
                ...
                <div class="text-center">
                    <p class="text-3xl font-extrabold text-primary">5-8.5h</p>
                    <p class="text-xs text-secondary">Completion time</p>
                </div>
                <div class="h-10 w-px bg-surface-container"></div>
                <div class="text-center">
    ...
    <div class="max-w-4xl mx-auto px-6 sm:px-8">
        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl">
            ...
            <form class="timeless-quote-form p-6 sm:p-8 lg:p-12 space-y-8">
                ...
                <div>
                    <label class="text-[0.65rem] font-black uppercase text-secondary tracking-widest block mb-2">What type of bath?</label>
