<?php /* Template Name: Shower Leak Repair Sydney */ ?>
<?php get_header(); ?>
...
<script type="application/ld+json">
{
    ...
    "description": "Professional leaking shower repair service in Sydney. Silicone replacement, grout sealing, and waterproof regrouting to stop shower leaks permanently.",
    "provider": {
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        { "@type": "Question", "name": "How much does it cost to fix a leaking shower?", "acceptedAnswer": { "@type": "Answer", "text": "Every bathroom is different. We provide fixed-price quotes based on your photos — no hidden fees, no surprises. Send us photos for a quote within hours." } },
        { "@type": "Question", "name": "Can regrouting fix a leaking shower?", "acceptedAnswer": { "@type": "Answer", "text": "In most cases yes. 80%+ of shower leaks come from failed grout or silicone, not the waterproofing membrane. Regrouting with waterproof epoxy seals the joints permanently." } },
        { "@type": "Question", "name": "How do I know if it's a grout leak or waterproofing failure?", "acceptedAnswer": { "@type": "Answer", "text": "If water appears on walls/ceiling below only when the shower is used, it's likely grout/silicone. If it appears continuously even when dry, the waterproofing membrane may have failed — that needs a licensed waterproofer. We'll advise during your quote." } },
        { "@type": "Question", "name": "Should I choose cement or epoxy grout?", "acceptedAnswer": { "@type": "Answer", "text": "For leaking showers, we strongly recommend epoxy grout. It's 100% waterproof (cement grout is porous), stain-proof, and never needs sealing. Costs more upfront but prevents future leaks." } },
        { "@type": "Question", "name": "How long until I can use the shower?", "acceptedAnswer": { "@type": "Answer", "text": "24 hours after silicone or grout work to allow full cure. Don't rush this — premature water exposure can compromise the seal." } }
    ]
}
</script>
...
<section class="pt-4 pb-16 sm:pb-20 bg-surface">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
            ...
            <div class="grid grid-cols-3 gap-3 sm:flex sm:items-center sm:gap-6 mb-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs text-secondary">Same-day service</p>
                </div>
                <div class="hidden sm:block h-10 w-px bg-surface-container"></div>
                <div class="text-center">
                    <p class="text-base sm:text-3xl font-extrabold text-primary whitespace-nowrap">2yr</p>
                    <p class="text-xs text-secondary">Workmanship warranty</p>
                </div>
            </div>
        ...
        <div class="aspect-[4/3] bg-surface-container-highest rounded-xl overflow-hidden shadow-xl">
            <img class="w-full h-full object-cover" alt="Professional shower leak repair in Sydney - technician sealing shower joints with waterproof silicone" src="<?php echo get_template_directory_uri(); ?>/images/services/shower-leak-repair/hero.jpg" loading="eager" width="800" height="600" />
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        <div class="max-w-3xl mx-auto text-center mb-12 lg:mb-16">
            ...
            <h2 class="text-3xl sm:text-4xl font-extrabold text-primary tracking-tighter mb-3">Expert Shower Sealing</h2>
...
<section class="py-16 sm:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4">Why Fix Leaks Now</h2>
        <p class="text-secondary max-w-3xl mb-10">A leaking shower doesn't fix itself. Every day you wait, the damage behind your tiles gets worse &mdash; and more expensive to repair.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-surface-container-low rounded-xl p-6 reveal">
                ...
                <h3 class="font-bold text-primary mb-2">Hidden Damage</h3>
                <p class="text-sm text-secondary leading-relaxed">Water behind tiles rots timber framing, causes paint bubbling, and damages adjacent rooms. Gets worse daily.</p>
            </div>
            <div class="bg-surface-container-low rounded-xl p-6 reveal">
                ...
                <p class="text-sm text-secondary leading-relaxed">Constant moisture behind tiles creates mould that's invisible until it spreads. Health hazard for your family.</p>
            </div>
            <div class="bg-surface-container-low rounded-xl p-6 reveal">
                <span class="material-symbols-outlined text-3xl text-error mb-3 block" aria-hidden="true">trending_up</span>
                <h3 class="font-bold text-primary mb-2">Rising Costs</h3>
                <p class="text-sm text-secondary leading-relaxed">A quick silicone fix today prevents a $5,000+ waterproofing job if water damages the membrane.</p>
            </div>
            <div class="bg-surface-container-low rounded-xl p-6 reveal">
                <span class="material-symbols-outlined text-3xl text-error mb-3 block" aria-hidden="true">apartment</span>
                <h3 class="font-bold text-primary mb-2">Strata Liability</h3>
                <p class="text-sm text-secondary leading-relaxed">In apartments, your shower leak can damage the unit below. Fix now before it becomes a strata dispute.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4">How We Fix Your Leaking Shower</h2>
        <p class="text-secondary max-w-3xl mb-10">Our 4-step process identifies the leak source and seals it permanently.</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-xl p-6 text-center reveal">
                ...
                <h3 class="font-bold text-primary text-sm mb-2">Inspect</h3>
                <p class="text-xs text-secondary">Check grout condition, silicone joints, and test for active leaks. Identify the source.</p>
            </div>
            <div class="bg-white rounded-xl p-6 text-center reveal">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mx-auto mb-4">2</div>
                <h3 class="font-bold text-primary text-sm mb-2">Remove Old</h3>
                <p class="text-xs text-secondary">Strip all failed silicone and/or remove cracked grout with oscillating tools.</p>
            </div>
            <div class="bg-white rounded-xl p-6 text-center reveal">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mx-auto mb-4">3</div>
                <h3 class="font-bold text-primary text-sm mb-2">Seal</h3>
                <p class="text-xs text-secondary">Apply waterproof epoxy grout and/or premium silicone at all junctions and corners.</p>
            </div>
            <div class="bg-white rounded-xl p-6 text-center reveal">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mx-auto mb-4">4</div>
                <h3 class="font-bold text-primary text-sm mb-2">Test</h3>
                <p class="text-xs text-secondary">Allow 24hr cure. Grout sealer applied to cement grout. Ready to use next day.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-20 bg-surface-container-low" id="faqs">
    <div class="max-w-3xl mx-auto px-6 sm:px-8">
        <h2 class="text-3xl font-extrabold text-primary tracking-tighter mb-4 text-center">Shower Sealing FAQs</h2>
        <p class="text-secondary text-center mb-10">Common questions about fixing leaking showers in Sydney.</p>

        <div class="space-y-3">
            <div class="faq-item border border-surface-container rounded-xl"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How much does it cost to fix a leaking shower?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">Every bathroom is different. We provide fixed-price quotes based on your photos &mdash; no hidden fees, no surprises. Send us photos for a quote within hours.</p></div></div>

            <div class="faq-item border border-surface-container rounded-xl"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Can regrouting fix a leaking shower?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">In most cases yes. 80%+ of shower leaks come from failed grout or silicone, not the waterproofing membrane. Regrouting with waterproof epoxy seals the joints permanently.</p></div></div>

            <div class="faq-item border border-surface-container rounded-xl"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How do I know if it's a grout leak or waterproofing failure?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">If water appears on walls or ceiling below only when the shower is used, it's likely a grout or silicone issue. If it appears continuously even when the shower is dry, the waterproofing membrane may have failed &mdash; that needs a licensed waterproofer. We'll advise during your quote.</p></div></div>

            <div class="faq-item border border-surface-container rounded-xl"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Should I choose cement or epoxy grout?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">For leaking showers, we strongly recommend epoxy grout. It's 100% waterproof (cement grout is porous), stain-proof, and never needs sealing. Costs more upfront but prevents future leaks.</p></div></div>

            <div class="faq-item border border-surface-container rounded-xl"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How long until I can use the shower?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">24 hours after silicone or grout work to allow full cure. Don't rush this &mdash; premature water exposure can compromise the seal.</p></div></div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-6 sm:px-8">
        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl">
            <div class="p-6 sm:p-8 lg:p-12 bg-primary text-white">
                <h2 class="text-2xl sm:text-3xl font-extrabold tracking-tight mb-2">Get Your Free Leak Repair Quote</h2>
            ...
            <form class="timeless-quote-form p-6 sm:p-8 lg:p-12 space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" checked /> Shower leak</label>
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" /> Shower silicone</label>
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" /> Bath leak</label>
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" /> Shower screen reseal</label>
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" /> Full regrout needed</label>
                        <label class="p-3 bg-surface-container-low rounded-lg flex items-center gap-2 text-xs font-medium cursor-pointer border border-surface-container hover:border-primary/30"><input type="checkbox" class="rounded text-primary" /> Not sure &mdash; just leaking</label>
                    </div>
                </div>
                <div><label for="notes" class="text-[0.75rem] sm:text-[0.65rem] font-black uppercase text-secondary tracking-widest block mb-2">Anything else?</label><textarea id="notes" name="notes" rows="3" class="w-full bg-surface-container-low border border-surface-container rounded-lg p-4 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none" placeholder="e.g. water appearing on ceiling below, grout is cracked, silicone is peeling, strata has complained..."></textarea></div>
                <button class="w-full py-4 bg-primary text-white font-bold rounded-lg shadow-lg hover:bg-primary-container transition-all flex items-center justify-center gap-2" type="submit">Get My Free Leak Repair Quote <span class="material-symbols-outlined" aria-hidden="true">send</span></button>
