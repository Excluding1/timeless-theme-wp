...
<script type="application/ld+json">
{
 ...
 "mainEntity": [
 { "@type": "Question", "name": "What exactly is bathroom resurfacing?", "acceptedAnswer": { "@type": "Answer", "text": "Bathroom resurfacing is a process where we apply a durable coating over your existing surfaces. It costs up to 80% less than a full renovation and lasts up to 10 years with proper care." } },
 { "@type": "Question", "name": "How much does bathroom resurfacing cost in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Every bathroom is different. Resurfacing is up to 80% cheaper than a full renovation ($25K-$50K). Send us photos for an accurate, fixed-price quote." } },
...
<section class="py-12 sm:py-16 bg-surface">
 ...
 <div class="space-y-3">
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-5 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">What exactly is bathroom resurfacing?</h3><span class="material-symbols-outlined faq-chevron text-primary" aria-hidden="true">expand_more</span></button><div class="faq-answer px-5"><p class="text-sm text-secondary leading-relaxed pb-5">Bathroom resurfacing is a process where we apply a durable, factory-grade coating over your existing surfaces. Bathtubs, tiles, basins, and vanities. Instead of ripping everything out and starting again, we restore what&rsquo;s already there. It costs up to 80% less than a full renovation and lasts up to 10 years with proper care.</p></div></div>
