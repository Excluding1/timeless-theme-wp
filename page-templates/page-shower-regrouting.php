...
<script type="application/ld+json">
{
 ...
 { "@type": "ListItem", "position": 3, "name": "Shower Regrouting Sydney", "item": "https://timelessresurfacing.com.au/services/shower-regrouting/" }
 ]
}
</script>
...
<script type="application/ld+json">
{
 ...
 "mainEntity": [
 { "@type": "Question", "name": "How much does shower regrouting cost in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Every shower is different. The cost depends on shower size, tile type, grout choice (epoxy or cement), and current condition. Send us photos and we'll have a fixed-price quote back within 1 business day. No hidden fees." } },
...
<section class="pt-4 pb-10 sm:pb-16 bg-surface">
 ...
 <span class="inline-block py-1 px-3 bg-tertiary-fixed text-on-tertiary-fixed text-[0.7rem] font-bold tracking-widest uppercase rounded-sm mb-4">Waterproof Epoxy Grout</span>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 ...
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">1</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">~30 min</span><h3 class="font-bold text-primary mb-1">Protect &amp; Mask</h3><p class="text-sm text-secondary leading-relaxed">Drop sheets down, fixtures masked, drain protected. All dust and debris contained.</p></div></div>
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">2</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">2-3 hrs</span><h3 class="font-bold text-primary mb-1">Remove Old Grout</h3><p class="text-sm text-secondary leading-relaxed">Every joint ground out 2-4mm deep with precision oscillating tools. Old silicone stripped.</p></div></div>
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">3</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">2-3 hrs</span><h3 class="font-bold text-primary mb-1">Apply New Grout</h3><p class="text-sm text-secondary leading-relaxed">Fresh epoxy or cement grout pressed into every joint. Excess cleaned off before it sets.</p></div></div>
...
<section class="py-10 sm:py-12 bg-surface">
 ...
 <div class="flex items-start gap-3"><div class="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5"><span class="material-symbols-outlined text-lg text-primary" aria-hidden="true">verified_user</span></div><div><h3 class="font-bold text-primary text-sm">Up to 5-Year Warranty</h3><p class="text-xs text-secondary leading-relaxed">Epoxy: 5yr. Cement: 2yr. Insured for $10 million public liability.</p></div></div>
