...
<script type="application/ld+json">
 ...
 { "@type": "ListItem", "position": 3, "name": "Vanity Refinishing", "item": "https://timelessresurfacing.com.au/services/vanity-refinishing/" },
 { "@type": "ListItem", "position": 4, "name": "Vanity Respray", "item": "https://timelessresurfacing.com.au/services/vanity-respray/" }
 ]
 }
 </script>
...
<div class="pt-24 pb-2 px-6 sm:px-8 max-w-7xl mx-auto">
 ...
 <li><span class="mx-1">/</span></li>
 <li><a href="<?php echo esc_url( home_url( '/services/vanity-refinishing/' ) ); ?>" class="hover:text-primary transition-colors">Vanity Refinishing</a></li>
 <li><span class="mx-1">/</span></li>
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <p class="text-secondary max-w-3xl mb-10">Vanity respraying is a professional refinishing process that gives your existing bathroom cabinet a completely new look. It's not brush painting. We use automotive-grade two-part coatings spray-applied with professional equipment for a factory-smooth finish. The process works on virtually any vanity surface including laminate, timber, MDF, and melamine.</p>
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <p class="text-xs text-secondary leading-relaxed">A bonding primer specifically suited to your vanity's surface type is applied. This is the foundation of a lasting finish. The primer creates a chemical bond between the surface and the topcoat.</p>
 </div>
 <div class="bg-surface-container-low rounded-xl p-6 reveal">
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 ...
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-error text-base shrink-0" aria-hidden="true">close</span> $1,500-$5,000+ for a quality vanity unit</li>
 ...
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-primary text-base shrink-0" aria-hidden="true">check</span> No plumber needed. Nothing is disconnected</li>
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-primary text-base shrink-0" aria-hidden="true">check</span> No wall or floor damage. Vanity stays in place</li>
 <li class="flex items-start gap-2"><span class="material-symbols-outlined text-primary text-base shrink-0" aria-hidden="true">check</span> Choose any colour. Modern whites, greys, dark tones</li>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 ...
 <p class="text-secondary max-w-3xl mb-10">While we're refreshing your vanity, it's often worth tackling other bathroom updates at the same time. Saving you time and a second visit.</p>
