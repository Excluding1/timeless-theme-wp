...
<section class="py-10 sm:py-12 bg-surface">
 ...
 <div class="flex items-start gap-3"><div class="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5"><span class="material-symbols-outlined text-lg text-primary" aria-hidden="true">verified_user</span></div><div><h3 class="font-bold text-primary text-sm">Silicone 1yr &middot; Epoxy 5yr</h3><p class="text-xs text-secondary leading-relaxed">Workmanship covered. Insured for $10 million public liability.</p></div></div>
