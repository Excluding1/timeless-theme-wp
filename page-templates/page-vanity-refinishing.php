...
<section class="pt-4 pb-16 sm:pb-20 bg-[#1b2a4a] text-white" style="margin-top:-96px; padding-top:120px;">
 ...
 <img src="<?php echo get_template_directory_uri(); ?>/images/services/vanity-refinishing/hero-after.png" alt="Refinished vanity, modern white gloss finish" class="w-full h-full object-cover" draggable="false" />
 </div>
 ...
 <span class="text-xs font-bold text-primary-soft">Completed in Hours</span>
 </div>
 </div>
 </div>
 ...
 <span class="text-xs font-bold text-primary">Drag to Compare</span>
 <span class="text-xs font-bold text-primary-soft">Transformed in 1 Day</span>
 </div>
 </div>
 </div>
 </div>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 ...
 <div><p class="font-bold text-primary text-sm">$2,000 - $5,000+</p><p class="text-xs text-secondary">Vanity + plumber + installer + disposal</p></div>
 </li>
 <li class="flex items-start gap-3">
 <span class="material-symbols-outlined text-red-500 text-lg mt-0.5 shrink-0" aria-hidden="true">close</span>
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full mb-3">30-45 min</span>
