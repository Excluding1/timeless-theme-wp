...
<section class="pt-4 pb-16 sm:pb-20 bg-surface">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="aspect-[4/3] bg-surface-container-highest rounded-xl overflow-hidden shadow-xl">
            <img class="w-full h-full object-cover" alt="Professional shower regrouting in Sydney - technician applying fresh epoxy grout to shower tiles" src="https://images.unsplash.com/photo-1629079447777-1e605162dc8d?w=800&h=600&fit=crop&auto=format&q=80" loading="eager" width="800" height="600" />
        </div>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-6 sm:px-8">
        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl">
            ...
            <form class="timeless-quote-form p-6 sm:p-8 lg:p-12 space-y-8">
                ...
                <div>
                    <label class="text-[0.65rem] font-black uppercase text-secondary tracking-widest block mb-2">What needs regrouting?</label>
