...
<div class="pt-24 pb-2 px-6 sm:px-8 max-w-7xl mx-auto">
 ...
 <li class="text-primary font-medium">Warranty</li>
 </ol>
 </nav>
</div>
...
<section class="pt-4 pb-16 sm:pb-20 bg-surface">
 ...
 <!-- WARRANTY MATRIX -->
 <div class="reveal">
 <h2 class="text-xl font-bold text-primary mb-4">Warranty Periods by Service</h2>
 <p class="mb-5 text-sm">The table below shows the workmanship warranty for each service. <strong>Owner-Occupier</strong> applies to homes and strata-unit owners. <strong>Rental</strong> applies to tenanted investment properties.</p>
 ...
 <th class="text-left p-3 font-semibold">Owner-Occupier / Strata Unit</th>
 <th class="text-left p-3 font-semibold">Rental</th>
 </tr>
 </thead>
 ...
 <tr class="border-b border-slate-200">
 <td class="p-3 font-medium text-primary">Epoxy regrouting</td>
 <td class="p-3">5 years</td>
 <td class="p-3">12 months</td>
 </tr>
 <tr class="border-b border-slate-200">
 <td class="p-3 font-medium text-primary">Silicone replacement</td>
 <td class="p-3">12 months</td>
 <td class="p-3">90 days defect-only</td>
 </tr>
 <tr>
 <td class="p-3 font-medium text-primary">Shower screen re-bedding</td>
 <td class="p-3">12 months</td>
 ...
 <p class="text-xs text-secondary mt-4 italic">Combo packages (e.g. "full bathroom refresh") are warranted at the lowest-component level. Silicone is excluded from combo warranties as a wear item with separate 12-month replacement recommendation.</p>
 </div>
 ...
 <!-- WHAT'S COVERED -->
 <div class="reveal">
 <h2 class="text-xl font-bold text-primary mb-3">What the warranty covers</h2>
 <p class="mb-3">If the failure was caused by our workmanship, we'll come back and fix it free. Specifically:</p>
 <ul class="list-disc pl-6 space-y-2">
 <li>Resurfacing: peeling, bubbling, lifting, adhesion failure under normal use</li>
 <li>Regrouting: cracking, falling out, bond failure under normal use</li>
 <li>Silicone: bond failure, lifting, gaps within the install (90 days on rentals)</li>
 <li>Shower screen re-bedding: leaking from the bedding line under normal water exposure</li>
 </ul>
 </div>
 ...
 <h2 class="text-xl font-bold text-primary mb-3">For landlords and property managers</h2>
 <p class="mb-3">Tenanted bathrooms see harder daily use, more varied cleaning products, and conditions we can't inspect or control between visits. Because of that, we offer focused workmanship warranties on rental work:</p>
 ...
 <!-- HOW TO CLAIM -->
 <div class="reveal">
 <h2 class="text-xl font-bold text-primary mb-3">How to claim warranty</h2>
 <ol class="list-decimal pl-6 space-y-2">
 <li>Email us at <a href="mailto:<?php echo timeless_email(); ?>" class="text-primary underline"><?php echo timeless_email(); ?></a> with photos of the issue and your original job invoice number.</li>
 <li>We'll respond within 2 business days to schedule an assessment.</li>
 <li>If the issue is covered, we'll re-do the work at no charge.</li>
 <li>If the issue isn't covered (e.g. damage from harsh chemicals or tenant wear), we'll quote you for a paid repair.</li>
 </ol>
 </div>
 ...
 <div class="reveal text-center pt-4">
 <p class="mb-4 text-sm">Looking after your resurfacing properly extends its life and protects your warranty.</p>
 <a href="<?php echo esc_url( home_url( '/care-instructions/' ) ); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
 <span>Read Care Instructions</span>
