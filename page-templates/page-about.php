    ...
    <div class="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-5 relative reveal">
            <div class="aspect-[4/5] rounded-xl overflow-hidden shadow-2xl border-[10px] border-white">
                <img class="w-full h-full object-cover" alt="Timeless Resurfacing professional bathroom transformation in Sydney" src="<?php echo get_template_directory_uri(); ?>/images/about/hero.jpg" loading="eager" width="600" height="750" />
            </div>
        </div>
    </div>
</section>
        ...
        <div class="flex flex-col lg:flex-row gap-16 lg:gap-20">
            ...
            <div class="lg:w-1/2 reveal">
                <div class="grid grid-cols-2 gap-4">
                    <img class="rounded-lg shadow-lg mt-12 w-full h-auto aspect-[3/4] object-cover" alt="Professional bathroom resurfacing result — gleaming white bathtub" src="<?php echo get_template_directory_uri(); ?>/images/about/result.jpg" loading="lazy" width="400" height="533" />
                    <img class="rounded-lg shadow-lg w-full h-auto aspect-[3/4] object-cover" alt="Precision spray coating application on bathroom tiles" src="<?php echo get_template_directory_uri(); ?>/images/about/process.jpg" loading="lazy" width="400" height="533" />
                </div>
            </div>
        </div>
    </div>
