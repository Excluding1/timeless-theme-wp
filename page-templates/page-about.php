        ...
        <div class="flex flex-col lg:flex-row gap-16 lg:gap-20">
            ...
            <div class="lg:w-1/2 reveal">
                <div class="grid grid-cols-2 gap-4">
                    <img class="rounded-lg shadow-lg mt-12 w-full h-auto aspect-[3/4] object-cover" alt="Professional bathroom resurfacing result — gleaming white bathtub" src="<?php echo get_template_directory_uri(); ?>/images/about/bathroom.png" loading="lazy" width="400" height="533" />
                    <img class="rounded-lg shadow-lg w-full h-auto aspect-[3/4] object-cover" alt="Precision spray coating application on bathroom tiles" src="<?php echo get_template_directory_uri(); ?>/images/about/bathroom.png" loading="lazy" width="400" height="533" />
                </div>
            </div>
        </div>
    </div>
