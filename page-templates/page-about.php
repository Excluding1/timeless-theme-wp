    ...
    <div class="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-5 relative reveal">
            <div class="aspect-[4/5] rounded-xl overflow-hidden shadow-2xl border-[10px] border-white">
                <img class="w-full h-full object-cover" alt="Timeless Resurfacing professional bathroom transformation in Sydney" src="https://images.unsplash.com/photo-1507652313519-a3ecf64b1e48?w=600&h=750&fit=crop&auto=format&q=80" loading="eager" width="600" height="750" />
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div class="grid grid-cols-2 gap-5 reveal">
                ...
                <div class="bg-surface-container-low p-7 rounded-xl border-l-4 border-tertiary-fixed-dim">
                    ...
                    <p class="text-sm text-secondary leading-relaxed">Hawk Glass-Tech professional system &mdash; commercial-grade coatings that last 10&ndash;15 years.</p>
                </div>
                <div class="bg-primary-container p-7 rounded-xl">
        ...
        <div class="flex flex-col lg:flex-row gap-16 lg:gap-20">
            ...
            <div class="lg:w-1/2 reveal">
                <div class="grid grid-cols-2 gap-4">
                    <img class="rounded-lg shadow-lg mt-12 w-full h-auto aspect-[3/4] object-cover" alt="Professional bathroom resurfacing result — gleaming white bathtub" src="https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=400&h=533&fit=crop&auto=format&q=80" loading="lazy" width="400" height="533" />
                    <img class="rounded-lg shadow-lg w-full h-auto aspect-[3/4] object-cover" alt="Precision spray coating application on bathroom tiles" src="https://images.unsplash.com/photo-1629079447777-1e605162dc8d?w=400&h=533&fit=crop&auto=format&q=80" loading="lazy" width="400" height="533" />
                </div>
            </div>
        </div>
    </div>
