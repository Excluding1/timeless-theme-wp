...
<script type="application/ld+json">
{
 ...
 { "@type": "ListItem", "position": 3, "name": "Floor Tile Regrouting Sydney", "item": "https://timelessresurfacing.com.au/services/floor-tile-regrouting/" }
 ]
}
</script>
...
<script type="application/ld+json">
{
 ...
 "mainEntity": [
 { "@type": "Question", "name": "How much does floor tile regrouting cost in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Every floor is different. The cost depends on floor area, tile size, grout type (epoxy or cement), and current condition. Send us photos and we'll have a fixed-price quote back within 1 business day." } },
 { "@type": "Question", "name": "How long does floor regrouting take?", "acceptedAnswer": { "@type": "Answer", "text": "Most bathroom floors are completed in 4-8 hours (one day). Larger areas may take a second day. The floor can be walked on 24-48 hours after completion." } },
 { "@type": "Question", "name": "Can you just clean my floor grout instead of regrouting?", "acceptedAnswer": { "@type": "Answer", "text": "If the grout is structurally sound but just discoloured, professional cleaning plus sealing may be enough. If cracked, crumbling, or tiles are moving, full regrout is needed." } },
 { "@type": "Question", "name": "Should I choose epoxy or cement grout for my floor?", "acceptedAnswer": { "@type": "Answer", "text": "Epoxy is ideal for floors. Non-porous, never needs resealing, resists foot traffic wear and mopping. Cement is cheaper but needs resealing every 1-2 years." } },
 { "@type": "Question", "name": "Do you regrout laundry and kitchen floors too?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We regrout any tiled floor in wet areas including bathrooms, laundries, kitchens, and entryways. Same process, same warranty." } }
 ]
}
</script>
...
<div class="pt-24 pb-2 px-6 sm:px-8 max-w-7xl mx-auto">
 ...
 <li><span class="mx-1">/</span></li>
 <li class="text-primary font-medium">Floor Tile Regrouting Sydney</li>
 </ol>
 </nav>
</div>
...
<section class="pt-4 pb-10 sm:pb-16 bg-surface">
 ...
 <span class="inline-block py-1 px-3 bg-tertiary-fixed text-on-tertiary-fixed text-[0.7rem] font-bold tracking-widest uppercase rounded-sm mb-4">Bathroom &amp; Laundry</span>
 ...
 <p class="text-[0.6rem] sm:text-[0.65rem] text-secondary font-medium mt-1">Most floors</p>
 </div>
 <div class="text-center bg-surface-container-low rounded-lg px-2 sm:px-3 py-3">
 ...
 <div class="rounded-xl overflow-hidden shadow-2xl relative" style="aspect-ratio:4/3;">
 <div class="absolute inset-0 bg-linear-to-br from-emerald-50 via-white to-[#e7c08b]/20 flex items-center justify-center">
 <img src="<?php echo get_template_directory_uri(); ?>/images/services/floor-tile-regrouting/hero.png" alt="Floor tile regrouting before and after" class="w-full h-full object-cover" />
 </div>
 <span class="absolute top-3 left-3 bg-black/60 text-white text-[0.6rem] font-bold uppercase tracking-widest px-2.5 py-1 rounded-sm" style="z-index:15;">Before</span>
 <span class="absolute top-3 right-3 bg-white/80 text-primary text-[0.6rem] font-bold uppercase tracking-widest px-2.5 py-1 rounded-sm" style="z-index:15;">After</span>
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <h2 class="text-3xl sm:text-4xl font-extrabold text-primary tracking-tighter mb-3">Common Floor Grout Problems</h2>
 <p class="text-secondary">These are the floor grout issues we fix every week across Sydney. If yours looks like any of these, we can have it sorted in a day.</p>
 </div>

 <!-- BLOCK 1: Cracked & Crumbling Floor Grout -->
 <div class="mb-12 lg:mb-16 reveal">
 <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
 <div class="order-2 lg:order-1">
 <h3 class="text-2xl sm:text-3xl font-extrabold text-primary tracking-tight mb-3 text-center lg:text-left">Cracked &amp; Crumbling Floor Grout</h3>
 <p class="text-sm sm:text-base text-secondary leading-relaxed mb-5">Grout cracking between your bathroom or laundry floor tiles? Chunks coming loose when you sweep? Foot traffic, thermal expansion, and building movement cause floor grout to crack faster than wall grout. Every crack lets water through to the substrate. We grind out the damaged joints and fill with fresh sanded grout rated for foot traffic.</p>
 <ul class="space-y-2.5 mb-6">
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Sanded grout rated for heavy foot traffic</li>
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Stops water penetrating to the substrate</li>
 ...
 <!-- BLOCK 2: Discoloured & Stained Floor Grout -->
 <div class="mb-12 lg:mb-16 reveal">
 <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
 <div class="order-2 lg:order-2">
 <h3 class="text-2xl sm:text-3xl font-extrabold text-primary tracking-tight mb-3 text-center lg:text-left">Discoloured &amp; Stained Floor Grout</h3>
 <p class="text-sm sm:text-base text-secondary leading-relaxed mb-5">Floor grout started white but now it&rsquo;s brown, grey, or patchy? Years of mopping pushes dirty water into porous cement grout. Cleaning products leave residue that builds up in the joints. Foot traffic grinds dirt deeper every day. We replace the stained grout entirely so every joint is uniform, bright, and sealed.</p>
 <ul class="space-y-2.5 mb-6">
 ...
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Uniform colour across the entire floor</li>
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Epoxy option resists future staining permanently</li>
 </ul>
 <a href="#quote" class="flex w-fit items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-lg hover:shadow-lg transition-all mx-auto lg:mx-0">Get a Free Quote <span class="material-symbols-outlined text-base" aria-hidden="true">arrow_forward</span></a>
 </div>
 ...
 <!-- BLOCK 3: Mouldy Floor Grout -->
 <div class="reveal">
 <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
 <div class="order-2 lg:order-1">
 <h3 class="text-2xl sm:text-3xl font-extrabold text-primary tracking-tight mb-3 text-center lg:text-left">Mouldy Floor Grout</h3>
 <p class="text-sm sm:text-base text-secondary leading-relaxed mb-5">Black spots in your bathroom floor grout that keep coming back after cleaning? Mould grows <em>inside</em> porous cement grout, not just on the surface. In bathrooms and laundries where the floor stays damp, bleach only kills what you can see. The roots survive inside the grout and regrow within weeks. Full regrout is the permanent fix.</p>
 <ul class="space-y-2.5 mb-6">
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Full grout removal, not just a surface clean</li>
 ...
 <li class="flex items-start gap-2 text-sm text-secondary"><span class="material-symbols-outlined text-emerald-500 text-base shrink-0 mt-0.5" aria-hidden="true">check_circle</span> Healthier bathroom environment</li>
 </ul>
 <a href="#quote" class="flex w-fit items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-lg hover:shadow-lg transition-all mx-auto lg:mx-0">Get a Free Quote <span class="material-symbols-outlined text-base" aria-hidden="true">arrow_forward</span></a>
 </div>
 <div class="order-1 lg:order-2">
...
<section class="py-16 sm:py-20 bg-white">
 ...
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-amber-500 text-lg mt-0.5 shrink-0" aria-hidden="true">info</span><div><p class="font-bold text-primary text-sm">Needs resealing every 1-2 years</p><p class="text-xs text-secondary">Periodic resealing keeps it waterproof</p></div></li>
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-amber-500 text-lg mt-0.5 shrink-0" aria-hidden="true">info</span><div><p class="font-bold text-primary text-sm">Lifespan: 5-10 years on floors</p><p class="text-xs text-secondary">With regular sealing and proper ventilation</p></div></li>
 ...
 <ul class="space-y-4">
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-green-600 text-lg mt-0.5 shrink-0" style="font-variation-settings:'FILL' 1;" aria-hidden="true">check_circle</span><div><p class="font-bold text-primary text-sm">100% waterproof</p><p class="text-xs text-secondary">Zero water absorption, even with constant mopping</p></div></li>
 ...
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-green-600 text-lg mt-0.5 shrink-0" style="font-variation-settings:'FILL' 1;" aria-hidden="true">check_circle</span><div><p class="font-bold text-primary text-sm">Never needs resealing</p><p class="text-xs text-secondary">Set and forget. No annual maintenance.</p></div></li>
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-green-600 text-lg mt-0.5 shrink-0" style="font-variation-settings:'FILL' 1;" aria-hidden="true">check_circle</span><div><p class="font-bold text-primary text-sm">Resists foot traffic wear</p><p class="text-xs text-secondary">Harder than cement, doesn&rsquo;t crack or crumble</p></div></li>
 <li class="flex items-start gap-3"><span class="material-symbols-outlined text-green-600 text-lg mt-0.5 shrink-0" style="font-variation-settings:'FILL' 1;" aria-hidden="true">check_circle</span><div><p class="font-bold text-primary text-sm">Lifespan: 15-20 years</p><p class="text-xs text-secondary">Outlasts cement by 2-3x on high-traffic floors</p></div></li>
...
<section class="py-16 sm:py-20 bg-surface-container-low">
 <div class="max-w-7xl mx-auto px-6 sm:px-8">
 <div class="max-w-3xl mx-auto text-center mb-12 lg:mb-16">
 <h2 class="text-3xl sm:text-4xl font-extrabold text-primary tracking-tighter mb-3">How We Regrout Your Floor</h2>
 <p class="text-secondary">A 4-step process. Most bathroom floors completed in one day.</p>
 </div>
 <!-- DESKTOP -->
 ...
 <p class="text-xs text-secondary leading-relaxed">Furniture moved, fixtures covered, dust barriers set up. Drain protected from debris.</p>
 </div>
 <div class="flex flex-col items-center text-center px-4 reveal">
 ...
 <span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full mb-3">2-4 hrs</span>
 <h3 class="font-bold text-primary text-sm mb-2">Remove Old Grout</h3>
 <p class="text-xs text-secondary leading-relaxed">Every joint ground out 2-4mm deep with oscillating tools. Floor joints are wider, so this takes longer than walls.</p>
 </div>
 <div class="flex flex-col items-center text-center px-4 reveal">
 ...
 <p class="text-xs text-secondary leading-relaxed">Fresh sanded grout (epoxy or cement) pressed into every joint. Excess cleaned off tiles before setting.</p>
 </div>
 <div class="flex flex-col items-center text-center px-4 reveal">
 ...
 <h3 class="font-bold text-primary text-sm mb-2">Cure &amp; Cleanup</h3>
 <p class="text-xs text-secondary leading-relaxed">Area cleaned up, furniture replaced. Light foot traffic after 24 hours, full cure in 48 hours.</p>
 </div>
 </div>
 </div>
 <!-- MOBILE -->
 <div class="lg:hidden space-y-0">
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">1</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">~30 min</span><h3 class="font-bold text-primary mb-1">Protect &amp; Mask</h3><p class="text-sm text-secondary leading-relaxed">Furniture moved, fixtures covered, dust barriers up. Drain protected from debris.</p></div></div>
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">2</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">2-4 hrs</span><h3 class="font-bold text-primary mb-1">Remove Old Grout</h3><p class="text-sm text-secondary leading-relaxed">Every joint ground out 2-4mm deep. Floor joints are wider, so this takes longer than walls.</p></div></div>
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">3</span></div></div><div class="w-[2px] flex-1 bg-[#e7c08b]/30 mt-2"></div></div><div class="pb-8 pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">2-3 hrs</span><h3 class="font-bold text-primary mb-1">Apply New Grout</h3><p class="text-sm text-secondary leading-relaxed">Fresh sanded grout pressed into every joint. Excess cleaned off before setting.</p></div></div>
 <div class="flex gap-4 reveal"><div class="flex flex-col items-center shrink-0"><div class="w-11 h-11 rounded-full bg-white shadow-xs flex items-center justify-center"><div class="w-9 h-9 rounded-full bg-[#e7c08b]/20 flex items-center justify-center"><span class="text-base font-black text-[#7a5c10]">4</span></div></div></div><div class="pt-1"><span class="text-[0.6rem] font-bold uppercase tracking-widest bg-[#e7c08b]/15 text-[#7a5c10] px-2.5 py-1 rounded-full inline-block mb-2">24-48 hrs</span><h3 class="font-bold text-primary mb-1">Cure &amp; Cleanup</h3><p class="text-sm text-secondary leading-relaxed">Area cleaned, furniture replaced. Light foot traffic after 24 hours, full cure in 48.</p></div></div>
 </div>
 </div>
</section>
...
<div class="bg-primary py-5 sm:py-6">
 ...
 <p class="text-white font-bold text-sm sm:text-base text-center sm:text-left">Ready to fix your floor grout? Send us photos for a free quote in hours.</p>
...
<section class="py-10 sm:py-12 bg-surface">
 ...
 <div class="flex items-start gap-3"><div class="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5"><span class="material-symbols-outlined text-lg text-primary" aria-hidden="true">schedule</span></div><div><h3 class="font-bold text-primary text-sm">Same-Day Service</h3><p class="text-xs text-secondary leading-relaxed">Most bathroom floors regrouted in a single day.</p></div></div>
 ...
 <div class="flex items-start gap-3"><div class="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5"><span class="material-symbols-outlined text-lg text-primary" aria-hidden="true">cleaning_services</span></div><div><h3 class="font-bold text-primary text-sm">No Mess Promise</h3><p class="text-xs text-secondary leading-relaxed">Drop sheets, dust extraction, full cleanup. Cleaner than we found it.</p></div></div>
 </div>
 </div>
</section>
...
<section class="py-14 sm:py-16 bg-surface-container-low" id="faqs">
 ...
 <p class="text-sm text-secondary leading-relaxed mb-6">Not sure if your floor grout needs cleaning or full regrout? Wondering about epoxy vs cement for floors? These are the questions we hear most. If yours isn&rsquo;t here, send us a message. No pressure.</p>
 ...
 <div class="space-y-2">
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How much does floor regrouting cost?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">Every floor is different. The cost depends on floor area, tile size, grout type (epoxy or cement), and current condition. Send us 3-4 photos and we&rsquo;ll have a fixed-price quote back within 1 business day. The number you see is the number you pay.</p></div></div>
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How long does it take?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">Most bathroom floors are completed in 4-8 hours (one day). Larger areas like combined bathroom and laundry may take a second day. The floor can be walked on 24-48 hours after completion.</p></div></div>
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Can you just clean my grout instead?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">If the grout is structurally sound but just discoloured, professional cleaning plus sealing may be enough. If it&rsquo;s cracked, crumbling, or tiles are moving, full regrout is the only lasting fix. We&rsquo;ll tell you which you need after seeing photos.</p></div></div>
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Should I choose epoxy or cement for my floor?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">Epoxy is ideal for floors. It&rsquo;s non-porous, never needs resealing, and resists staining from mopping and foot traffic. Cement grout works but needs resealing every 1-2 years. Most homeowners skip resealing, which accelerates failure.</p></div></div>
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">Do you regrout laundry and kitchen floors too?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">Yes. We regrout any tiled floor in wet areas including bathrooms, laundries, kitchens, and entryways. Same process, same warranty.</p></div></div>
