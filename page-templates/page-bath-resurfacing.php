...
<section class="py-10 sm:py-12 bg-surface">
 ...
 <p class="text-xs text-secondary leading-relaxed">Workmanship covered. Insured for $10 million public liability.</p>
 </div>
 </div>
 <div class="flex items-start gap-3">
 <div class="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 mt-0.5">
...
<section class="py-14 sm:py-16 bg-surface-container-low" id="faqs">
 ...
 <div class="faq-item border border-surface-container rounded-xl bg-white"><button class="w-full flex justify-between items-center p-4 text-left" onclick="toggleFaq(this)"><h3 class="font-bold text-primary text-sm pr-4">How long does it last?</h3><span class="material-symbols-outlined faq-chevron text-primary text-xl" aria-hidden="true">expand_more</span></button><div class="faq-answer px-4"><p class="text-sm text-secondary leading-relaxed pb-4">A professionally resurfaced bath typically lasts 10 to 15 years with normal household use, and where you land in that range comes down to how it is cleaned and what gets left sitting on it. Warm soapy water and a soft cloth or microfibre handles about ninety per cent of it, and a neutral pH bathroom cleaner covers the rest. Everything harsher than that is what wears a finish out. Abrasive pastes like Jif, Ajax, Gumption and Barkeeper&rsquo;s Friend, along with scouring pads, steel wool and magic erasers, will all dull the gloss, while neat bleach, ammonia, oven cleaner and drain cleaner attack the coating itself. Acidic cleaners do the same, so vinegar and CLR are out too, even though vinegar gets recommended everywhere as the gentle natural option, and keep acetone and nail polish remover well away from it. The other things that shorten a finish are impacts, since a dropped shampoo bottle or a tool can chip it, and anything left standing on the base, because bottles, pooled water and rubber mats trap moisture against the surface and slowly break the bond, which is why a mat with suction cups is the worst thing you can put in a resurfaced bath. Strong direct sun through a bathroom window will fade the colour over the years. Let it cure for the full time we specify on your job card before anyone uses it, keep mats and bottles off the base, and wipe it dry after use, and it will hold its finish for the full fifteen. Lifespan and warranty are separate things: your workmanship is covered for up to 5 years against peeling, bubbling and adhesion failure.</p></div></div>
