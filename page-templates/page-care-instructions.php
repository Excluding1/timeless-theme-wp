...
<div class="pt-24 pb-2 px-6 sm:px-8 max-w-7xl mx-auto">
 ...
 <li class="text-primary font-medium">Care Instructions</li>
 </ol>
 </nav>
</div>
...
<section class="pt-4 pb-16 sm:pb-20 bg-surface">
 ...
 <h1 class="text-4xl sm:text-5xl font-extrabold text-primary tracking-tighter leading-[0.95] mb-4">Care Instructions</h1>
 <p class="text-lg text-secondary mb-10">Look after your resurfacing properly and it'll last 10-15 years. Here's exactly how. Bookmark this page or print the section that applies to you.</p>
 ...
 <th class="text-left p-2 text-white font-semibold">Service</th>
 <th class="text-left p-2 text-white font-semibold">Cure Time</th>
 <th class="text-left p-2 text-white font-semibold">What to Avoid</th>
 </tr>
 </thead>
 ...
 <tr class="border-b border-white/15">
 <td class="p-2 font-medium">Cement regrouting</td>
 <td class="p-2">24 hours water, 72 hours heavy use</td>
 <td class="p-2">No showering, ventilate to help cure</td>
 </tr>
 <tr class="border-b border-white/15">
 <td class="p-2 font-medium">Epoxy regrouting</td>
 <td class="p-2">48 hours</td>
 <td class="p-2">No water exposure</td>
 </tr>
 <tr class="border-b border-white/15">
 <td class="p-2 font-medium">Silicone replacement</td>
 <td class="p-2">24 hours</td>
 <td class="p-2">No water, don't pick at edges</td>
 </tr>
 <tr>
 <td class="p-2 font-medium">Shower screen re-bedding</td>
 <td class="p-2">24-48 hours</td>
 <td class="p-2">No water on bedding line, don't slam door for 7 days</td>
 </tr>
 </tbody>
 </table>
 </div>
 <p class="text-white/85 text-sm mt-4 italic">We'll write your exact cure times on the job card before we leave. If in doubt, give us a call.</p>
 </div>

 <!-- DAILY 30-SECOND ROUTINE -->
 <div class="reveal">
 <h2 class="text-xl font-bold text-primary mb-3">The 30-second daily routine</h2>
 <p class="mb-3">After every shower or bath, this 30-second habit prevents 90% of long-term issues:</p>
 <ol class="list-decimal pl-6 space-y-2">
 <li>Squeegee shower walls and screen</li>
 <li>Wipe baths and benchtops dry with a microfibre cloth</li>
 <li>Run the exhaust fan for 20 minutes after showering</li>
 </ol>
 <p class="mt-3 text-sm bg-surface border-l-4 border-primary p-4 rounded-r-lg"><strong>Why it matters:</strong> Standing water and trapped humidity are the #1 cause of dulling, mineral spots, and mould. 30 seconds prevents thousands in repairs.</p>
 </div>
 ...
 <li>Selleys Bathroom Power Clean</li>
 <li>Method Daily Shower spray</li>
 <li>Bunnings own-brand pH-neutral bathroom or floor cleaner</li>
 <li>Soft sponge for stubborn soap scum</li>
 </ul>
 ...
 <details class="bg-white p-5 rounded-lg border border-slate-200">
 <summary class="font-bold text-primary cursor-pointer">Cement regrouting</summary>
 <div class="mt-4 space-y-2 text-sm">
 <p>24-hour cure on water, 72 hours heavy shower use. Seal grout annually with a penetrating sealer (Aqua Mix or Bondall from Bunnings).</p>
 <p>Clean with pH-neutral cleaner. Avoid bleach (eats the colour) and vinegar (eats the cement).</p>
 <p>Mould spots: 1 part bleach to 4 parts water on a toothbrush, rinse within 5 minutes. Don't let bleach sit.</p>
 </div>
 </details>
 ...
 <details class="bg-white p-5 rounded-lg border border-slate-200">
 <summary class="font-bold text-primary cursor-pointer">Shower screen re-bedding</summary>
 <div class="mt-4 space-y-2 text-sm">
 <p>24-48 hour cure on the bedding line. Don't lean on the screen or slam the door for 7 days.</p>
 <p>For the first month, squeegee glass and wipe the bedding line dry after every shower. After that, normal use is fine.</p>
 </div>
 </details>
 ...
 <li>Bubbling, peeling, or lifting on resurfaced surfaces</li>
 ...
 <!-- EXPECTED LIFESPAN -->
 <div class="reveal">
 <h2 class="text-xl font-bold text-primary mb-3">How long it'll actually last</h2>
 ...
 <p class="mt-3 text-sm italic">These are realistic expectations, not warranty figures. See our <a href="<?php echo esc_url( home_url( '/warranty/' ) ); ?>" class="text-primary underline">Warranty page</a> for the formal coverage periods.</p>
 </div>
