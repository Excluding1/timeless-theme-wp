...
<section class="bg-primary-container text-white py-5">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 gap-3 sm:grid-cols-none sm:flex sm:flex-wrap sm:justify-between items-center sm:gap-4 sm:gap-6">
