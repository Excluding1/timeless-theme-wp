    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" id="gallery-grid">
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="bath-resurfacing">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/bathtub-before.png" alt="Bathtub before resurfacing Sydney" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/bathtub-after.png" alt="Bathtub after professional resurfacing" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="bath-resurfacing">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/stain-before.png" alt="Stained yellowed bathtub before resurfacing" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/stain-after.png" alt="Bathtub after stain removal" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Bathtub Resurfacing</span></div>
            </article>
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="bath-resurfacing">
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="bath-resurfacing">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/worn-before.png" alt="Worn rough bathtub surface before resurfacing" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/bath-resurfacing/worn-after.png" alt="Bathtub after resurfacing smooth finish" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Bathtub Resurfacing</span></div>
            </article>
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="vanity">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/vanity-refinishing/dated-before.png" alt="Dated dull vanity with outdated finish" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/vanity-refinishing/dated-after.png" alt="Modern refinished vanity after colour change" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Vanity Refinishing</span></div>
            </article>
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="vanity">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/vanity-refinishing/scratched-before.png" alt="Scratched stained vanity with water damage" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/vanity-refinishing/scratched-after.png" alt="Smooth refinished vanity after scratch and stain removal" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Vanity Refinishing</span></div>
            </article>
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="floor-regrouting">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/crumbling-before.png" alt="Cracked crumbling floor grout" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/crumbling-after.png" alt="Floor grout after repair" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="floor-regrouting">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/discoloured-before.png" alt="Discoloured floor grout" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/discoloured-after.png" alt="Clean floor grout" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Floor Regrouting</span></div>
            </article>
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="floor-regrouting">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/mouldy-before.png" alt="Mouldy floor grout" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/gallery/floor-tile-regrouting/mouldy-after.png" alt="Clean floor grout" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
                <div class="p-5 flex justify-center"><span class="text-[0.7rem] bg-tertiary-fixed-dim/20 text-primary px-3 py-1 rounded-full font-bold uppercase tracking-wider">Floor Regrouting</span></div>
            </article>
