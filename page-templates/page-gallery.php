    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" id="gallery-grid">
            ...
            <article class="gallery-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" data-category="shower-regrouting">
                <div class="grid grid-cols-2"><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/services/tile-resurfacing/grout-before.png" alt="Dirty grout before" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 left-2 bg-black/60 text-white text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">Before</span></div><div class="relative aspect-square overflow-hidden"><img src="<?php echo $t; ?>/images/services/tile-resurfacing/grout-after.png" alt="Clean grout after regrouting" class="w-full h-full object-cover" loading="lazy" /><span class="absolute top-2 right-2 bg-white/80 text-primary text-[0.55rem] font-bold uppercase tracking-widest px-2 py-0.5 rounded">After</span></div></div>
