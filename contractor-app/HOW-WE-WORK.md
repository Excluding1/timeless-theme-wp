...
Pricing, payments and customer contact stay with us. If a customer asks what the job costs, just say: *"That's all handled through the office."* You invoice us for the work you complete — simple.
...
- **A customer wants to book me directly / asks for my number** → "Best to go through the office, — they look after the booking and the warranty." Don't hand out your details for a customer we sent you.
...
**(e) IN-APP WORDING SIMPLIFIED 2026-06-09 (Allan):** the live sub-facing copy is now plain + dash-free, the customer line says "**the office**" (not "the Timeless office"), and the FAQ is a tap-to-expand accordion. Canonical wording = the app screen `web/src/pages/HowWeWork.tsx`; the prose in this doc is the panel-reviewed substance for the lawyer (unchanged in meaning).
